...
- **Centers of influence and cold / misc are not coached** (Frank, 2026-09-24:
  "we barely use them and center of influence we dont even talk to the
  client, only the referral partner"). Nor are one-offs, commercial, BOB or
  Rewrite. `coaching_cards.split_by_lead_source` moves those calls out of
  the day's cards into `not_coached_calls`, so they reach no coaching figure
  and never seed Role Play. Role Play draws its lead source from the
  producer's own coached calls over the trailing 4 weeks.
